...
//        setContentView(R.layout.app_first_screen)
        ...
        val prfes = getPreferences(Context.MODE_PRIVATE).edit().putString("userName" , "tempUser").commit()
        setContentViewForMainLayout(showList = true)
...
//        applyFontToMenuItem(popupMenu.menu.getItem(2) , this.getPreferences(Context.MODE_PRIVATE).getString("LOG" , "Αλλαγή ασθνεούς")!! , applicationContext )
        applyFontToMenuItem(popupMenu.menu.getItem(2) , "Προσθήκη Ασθενούς" , applicationContext )
//        applyFontToMenuItem(popupMenu.menu.getItem(3) , "Doctor Log Out" , applicationContext)
        applyFontToMenuItem(popupMenu.menu.getItem(3) , this.getPreferences(Context.MODE_PRIVATE).getString("userName" , "tempUser") + " δεδομένα" , applicationContext )
        applyFontToMenuItem(popupMenu.menu.getItem(4) , "Καθαρισμός δεδομένων" , applicationContext )
        applyFontToMenuItem(popupMenu.menu.getItem(5) , "Όροι Χρήσης" , applicationContext )
        applyFontToMenuItem(popupMenu.menu.getItem(6) ,"Πίνακας αποτελεσμάτων" , applicationContext)
