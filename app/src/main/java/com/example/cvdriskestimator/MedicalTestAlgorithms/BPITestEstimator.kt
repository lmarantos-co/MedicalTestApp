...
class BPITestEstimator(allPatientValues : ArrayList<Int?>) {
    ...
    {
        var PSS = ((patientValues[0]?.plus(patientValues[1]!! ?: ) + patientValues[2]!! + patientValues[3]!!) / 4).toFloat()
        var PIS = (((patientValues[5]?.plus(patientValues[6]!!) ?: ) + patientValues[7]!! + patientValues[8]!! + patientValues[9]!! + patientValues[10]!! + patientValues[11]!!) / 5).toFloat()
