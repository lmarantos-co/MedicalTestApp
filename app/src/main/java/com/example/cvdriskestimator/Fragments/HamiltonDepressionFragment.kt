...
//                    val d = SimpleDateFormat("yyyy-MM-dd").parse(localDate.toString())
                    historyTest = hadmPatientViewModel.fetchHistoryTest(patientId!! , testDateFormated!!)
                }
            }
            if (historyTest.runCatching {  } != null)
            {
    ...
    private fun setPatientData(test : Test)
    {
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            setQuestionRadioGroup(hamDCheckBinding.HAMDQ1RG , test.patientHAMDQ1)
            setQuestionRadioGroup(hamDCheckBinding.HAMDQ2RG , test.patientHAMDQ2)
            setQuestionRadioGroup(hamDCheckBinding.HAMDQ3RG , test.patientHAMDQ3)
            setQuestionRadioGroup(hamDCheckBinding.HAMDQ4RG , test.patientHAMDQ4)
            setQuestionRadioGroup(hamDCheckBinding.HAMDQ5RG , test.patientHAMDQ5)
            setQuestionRadioGroup(hamDCheckBinding.HAMDQ6RG , test.patientHAMDQ6)
            setQuestionRadioGroup(hamDCheckBinding.HAMDQ7RG , test.patientHAMDQ7)
            setQuestionRadioGroup(hamDCheckBinding.HAMDQ8RG , test.patientHAMDQ8)
            ...
            setQuestionRadioGroup(hamDCheckBinding.HAMDQ17RG , test.patientHAMDQ17)
