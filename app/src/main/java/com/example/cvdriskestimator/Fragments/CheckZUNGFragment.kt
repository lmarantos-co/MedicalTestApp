...
//                    val d = SimpleDateFormat("yyyy-MM-dd").parse(localDate.toString())
                    historyTest = zungPatientViewModel.fetchHistoryTest(patientId!! , testDate!!)
                }
            }
        ...
        //set the PopUpMenu
        popupMenu = PopUpMenu(zungCheckBinding.includePopUpMenu.termsRelLayout , mainActivity, this, registerFragment , null , leaderBoardFragment)
